...
public class MonTest extends TestCase {
    ...
    public void test_Histoire2() {
        ...
        int resulat[] = a.putRing("D", 5, "BLACK");//resultat[0]=clr, resultat[1]=nb_zeros, resultat[2]=nb_anneaux
    ...
    public void test_Histoire3() {
        ...
        assertTrue(a.putRing("D", 5, "BLACK")[0] == 0 || a.putRing("D", 5, "WHITE")[0] == 1);
    }
    ...
    public void test_Histoire5() {
        ...
        assertTrue(a.move_ring("D", 2, "D", 5, "BLACK")[3][5] == 0 || a.putRing("D", 5, "BLACK")[0] == 0);
        //assertTrue(a.put_marker("D",2,"BLANC")[3][2]==1 || a.put_marker("D", 3, "BLACK")[3][3]==0 );
        assertTrue(a.put_marker("D", 2, "BLACK")[3][2] == 0 && a.putRing("D", 6, "BLACK")[0] == 0);
        assertTrue(a.put_marker("D", 2, "BLACK")[3][2] == 0 && a.putRing("D", 7, "BLACK")[0] == 0);
    ...
    public void test_Histoire6() {
        ...
        //assertTrue(a.put_marker("E",5,"BLANC")[4][5]==1 || a.putRing("E",5,"BLANC")[0]==1);
        //assertTrue(a.put_marker("E",8,"BLANC")[4][8]==1 || a.putRing("E",5,"BLANC")[0]==1);
